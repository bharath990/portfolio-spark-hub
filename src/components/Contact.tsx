...
import { PhoneIcon, MailIcon, SendIcon } from "lucide-react";
    ...
    <section id="contact" className="section-padding">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Card className="card-hover">
                <CardContent className="p-6 flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">+91 8121974742</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="card-hover">
                <CardContent className="p-6 flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">bharathvamsisatti@gmail.com</p>
                  </div>
                </CardContent>
              </Card>
          ...
          <AnimatedSection animation="fadeIn" delay={400} className="lg:col-span-2">
            <Card>
              <CardContent className="p-6">
