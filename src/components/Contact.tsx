...
import { PhoneIcon, MailIcon, SendIcon, GithubIcon, LinkedinIcon, TwitterIcon, ExternalLinkIcon } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
                ...
                <CardContent className="p-6 flex items-center">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-muted-foreground">+91 8121974742</p>
              ...
              <Card className="card-hover group transition-all duration-300">
                <CardContent className="p-6 flex items-center">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-muted-foreground">bharathvamsisatti@gmail.com</p>
                    ...
                    <DialogContent className="sm:max-w-md">
                      ...
                      <div className="flex flex-col gap-4 mt-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium">bharathvamsisatti@gmail.com</span>
                          <Button variant="ghost" size="icon" onClick={() => copyToClipboard("bharathvamsisatti@gmail.com", "Email address")} 
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium">+91 8121974742</span>
                          <Button variant="ghost" size="icon" onClick={() => copyToClipboard("+918121974742", "Phone number")} 
                            className="h-6 w-6 rounded-full hover:bg-primary/10 ml-auto">
                            <ExternalLinkIcon className="h-3 w-3" />
                          </Button>
